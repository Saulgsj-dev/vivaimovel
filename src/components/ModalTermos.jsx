// src/components/ModalTermos.jsx
import React from "react";

export default function ModalTermos({ fechar }) {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center px-4">
      <div className="bg-white w-full max-w-2xl max-h-[80vh] overflow-y-auto rounded-lg shadow-lg p-6 relative">
        ...
        <h2 className="text-xl font-semibold mb-4 text-green-700">Política de Privacidade e Termos de Uso</h2>
...
em nosso banco de dados, identificados
...
II) Receber material informativo referente
...
seu critério e desejo em anunciar o bem
IMOVEL, caracterizando-o, informando
localização, titulo, descritivo, NÃO sendo
permitido informar qualquer forma de
...
disponibiliza acesso aos saites,
plataformas e afins possibilitando a
interação humana neste planeta.
OPÇÃO(ÕES) DE PLANO(S): São as
diversidades de escolha optativa de
veiculação do ANÚNCIO, QUE POR
...
USUÁRIOS.
POLITICA DO SITE: É a interpolação das
POLITICAS DE PRIVACIDADE e
QUALIDADE, seguindo prioritariamente
...
propriedade única, estruturada para
informar, elucidar e cadastrar, textos;
...
prioridade na GRATUIDADE, limitando о
acesso e divulgação dos anuncios,
segundo as regras de programação da
plataforma, com a cobrança remunerada,
para prioridades em divulgação( ões) e
excedentes em consultas, o valor poderá
...
transação entre USUÁRIOS E
ANUNCIANTES, apenas divulgamos os
anúncios.
1.3 Todo ANÚNCIO deve atender aos
preceitos deste contrato e POLITICA DО
SITE, quaisquer burla e ou excessos
estarão sujeitos às penalidades aqui
estabelecidos.
1.4 As regras de ANÚNCIOS fazem parte
da programação do SITE. Que liberará ou
bloqueará automáticamente o ANÚNCIO
que divergir da POLITICA DO SITE.
1.5 Tendo o ANUNCIANTE, optado por
planos prioritários de maior exposição, ou
ACESSO ao contato do USUÁRIO a cima
do limite, assim como tambem o USUÁRIO
que utilizou ao numeo de acessos
gratuituitos aos ANUNCIANTES, ira
remunerar a empresa APDIP BRASIL
LTDA, atravez de pagamento direto via PІХ,
BOLETO ou CARTÃO, o que autoriza desde
já, os bancos ou operadores de cartão de
crédito ou débito a confirmação de seus
dados bancários.
2) OBRIGAÇÕES DO SITE
2.1 A empresa CONTRATADA envidará
...
ANUNCIANTE e ou USUARIOS que venha
infrigir a POLICA DO SAITE, na sua visão
única, exclusiva e incontestável.
a
2.6 A PLATAFORMA se reserva ao direito
de não publicar, suspender ou não renovar
o ANÚNCIO que tente burlar o sistema do
SITE, informando contato numéricos ou
por extenso, fotos comunicativas de
contato do anunciante, imagens com
direitos autorais, impróprias, pornografia,
etc...
e
...
endereços de contato: telefônico, watzapp
e E-mail.
...
ANÚNCIO.
3.3 E de inteira responsabilidade do
anunciante, a disponibilidade para venda
...
negociado, ocorrendo crimes, estará
sujeito a sanções cíveis e penas previstas
em lei.
...
PROPRIETARIOS, CORRETORES E
IMOBILIÁRIAS, entretanto em se
detectando burla e ou tentativa de enganar
o sistema com a finalidade de publicitação
de mais ANUNCIOS GRÁTIS que o
permitido no SITE, estes anúncios serão
...
obrigações de indenizar recairão sobre
seus responsáveis legais, nos termos do
código civil brasileiro (país, tutores e
curadores)
...
ANÚNCIО.
3.9 O ANUNCIANTE concorda
integralmente com as clausulas e
condições de contrato, momento em que
nomeia o fórum da cidade do Rio de
Janeiro, para intermediar ou dirimir
qualquer dúvidas ou omissões, inerente a
este contrato.
ASSIM ESTANDO JUSTOS E
CONTRATADOS E ACEITAM COMO ESTА
ESCRITO atravez do OK.
          </p>
        </div>
      </div>
    </div>
